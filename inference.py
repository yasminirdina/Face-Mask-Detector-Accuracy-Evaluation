...
def main():
	while True:
		...
		cv2.putText(frame, "How many faces: "+str(len(faces)), (10,18),cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255,255,222), 2)
		cv2.putText(frame, "Without Mask Count: "+str(danger), (10,31),cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 0, 255), 2)
		cv2.putText(frame, "With Mask Count: "+str(no_risk), (10,44),cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 255, 0), 2)

		cv2.imshow("Face Mask Detector and Accuracy Evaluation - Yasmin Irdina", frame)
